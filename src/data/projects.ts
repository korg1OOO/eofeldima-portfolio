...
export const projectsLang = {
  pt: [
    ...
    },
    {
      ...
      longDescription: "Problema: Avaliação de professores era manual e ineficiente. Solução: Desenvolvi plataforma completa com interface moderna e responsiva. Resultado: Sistema oficial adotado pelo IFPR com feedback positivo de alunos e professores.",
    ...
    },
    {
      ...
      longDescription: "Problema: Criadores de conteúdo perdiam tempo fazendo thumbnails. Solução: Criei ferramenta com IA que gera thumbnails profissionais em segundos. Resultado: Usado por vários criadores de conteúdo com excelente feedback.",
      technologies: ["React", "Vite", "TypeScript", "Tailwind CSS"],
    ...
    },
    {
      ...
      longDescription: "Problema: Check-in manual era lento e gerava filas. Solução: Plataforma digital completa já em produção. Resultado: Hotéis e pousadas de Foz do Iguaçu usando diariamente.",
    ...
    },
    {
      ...
      longDescription: "Problema: Mercado de previsão precisava de análise inteligente. Solução: Ferramenta de previsão e análise em tempo real. Resultado: Ferramenta finalizada e funcional.",
      technologies: ["React", "TypeScript", "Tailwind CSS"],
  ...
  en: [
    ...
    },
    {
      ...
      longDescription: "Problem: Teacher evaluation was manual and inefficient. Solution: Built a modern, responsive platform. Result: Official system adopted by IFPR with positive feedback.",
      technologies: ["React", "Vite", "TypeScript", "Tailwind CSS"],
    ...
    },
    {
      ...
      longDescription: "Problem: Content creators wasted time making thumbnails. Solution: Built AI tool that generates thumbnails in seconds. Result: Used by multiple creators with excellent feedback.",
      technologies: ["React", "Vite", "TypeScript", "Tailwind CSS"],
    ...
    },
    {
      ...
      longDescription: "Problem: Manual check-in caused delays and queues. Solution: Complete digital platform already in production. Result: Hotels and inns using it daily.",
      technologies: ["React", "TypeScript", "Tailwind CSS"],
    ...
    },
    {
      ...
      longDescription: "Problem: Prediction markets needed intelligent analysis. Solution: Built real-time prediction and analysis tool. Result: Completed and fully functional.",
      technologies: ["React", "TypeScript", "Tailwind CSS"],
