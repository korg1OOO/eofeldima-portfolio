...
import { experienceDataLang } from "@/data/experience";
...
export function Experience() {
  ...
  const currentExperience = experienceDataLang[language];
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-4 pb-8">
            {t.experience.title} <span className="gradient-text">{t.experience.gradient}</span>
          </h2>
        </motion.div>
        ...
        <div className="relative">
          ...
          {currentExperience.map((exp, index) => (
            <motion.div
              ...
              className={`relative flex items-center justify-between mb-8 ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}
            >
