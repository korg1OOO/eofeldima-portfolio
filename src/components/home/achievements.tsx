...
const achievements = [
  {
    ...
    description: "Part-time Jobs and Freelancing Works finished",
    metric: "8+"
  },
  {
    icon: Users,
    title: "Different Users",
    description: "How many total users interacting with my projects",
    metric: "600+"
  },
  {
    icon: Target,
    title: "Study Time",
    description: "Total years studying programming (since 2022)",
    metric: "3+"
  },
  {
    icon: Briefcase,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Making a difference through studying, learning, and technical excellence
          </p>
        </motion.div>
